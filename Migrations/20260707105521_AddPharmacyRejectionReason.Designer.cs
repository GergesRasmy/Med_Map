...
namespace Med_Map.Migrations
{
    ...
    [Migration("20260707105521_AddPharmacyRejectionReason")]
    partial class AddPharmacyRejectionReason
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Med_Map.Models.AI.AiChatRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Med_Map.Models.AI.AiChatResponse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Med_Map.Models.AI.AiChatSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Med_Map.Models.Payments.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Med_Map.Models.Payments.PaymentLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Med_Map.Models.Payments.PaymentOrder", b =>
                {
                    b.Property<Guid>("PaymentId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Med_Map.Models.ordersANDmedicine.MedicineMaster", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Med_Map.Models.ordersANDmedicine.Orders", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("PharmacyUserId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Med_Map.Models.ordersANDmedicine.Recommendation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Med_Map.Models.ordersANDmedicine.Wallet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Med_Map.Models.ordersANDmedicine.WalletTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("CashoutMethodJson")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Med_Map.Models.ordersANDmedicine.WithdrawalRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Med_Map.Models.pharmacy.PharmacyService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Med_Map.Models.AI.AiChatRequest", b =>
                {
                    b.HasOne("Med_Map.Models.AI.AiChatSession", "Session")
                        .WithMany()
            ...
            modelBuilder.Entity("Med_Map.Models.AI.AiChatResponse", b =>
                {
                    b.HasOne("Med_Map.Models.AI.AiChatRequest", "Request")
                        .WithMany()
            ...
            modelBuilder.Entity("Med_Map.Models.Payments.PaymentLog", b =>
                {
                    b.HasOne("Med_Map.Models.Payments.Payment", "Payment")
                        .WithMany("Logs")
            ...
            modelBuilder.Entity("Med_Map.Models.Payments.PaymentOrder", b =>
                {
                    b.HasOne("Med_Map.Models.ordersANDmedicine.Orders", "Order")
                        .WithMany()
            ...
            modelBuilder.Entity("Med_Map.Models.customer.Customer", b =>
                {
                    b.HasOne("Med_Map.Models.ApplicationUser", "User")
                        .WithOne("Customer")
                        .HasForeignKey("Med_Map.Models.customer.Customer", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Med_Map.Models.ordersANDmedicine.OrderItem", b =>
                {
                    b.HasOne("Med_Map.Models.ordersANDmedicine.MedicineMaster", "Medicine")
                        .WithMany()
                    ...
                    b.HasOne("Med_Map.Models.pharmacy.PharmacyService", "Service")
                        .WithMany()
            ...
            modelBuilder.Entity("Med_Map.Models.ordersANDmedicine.Recommendation", b =>
                {
                    b.HasOne("Med_Map.Models.AI.AiChatResponse", "Response")
                        .WithMany()
            ...
            modelBuilder.Entity("Med_Map.Models.ordersANDmedicine.WalletTransaction", b =>
                {
                    ...
                    b.HasOne("Med_Map.Models.ordersANDmedicine.Wallet", "Wallet")
                        .WithMany()
            ...
            modelBuilder.Entity("Med_Map.Models.pharmacy.PharmacyInventory", b =>
                {
                    b.HasOne("Med_Map.Models.pharmacy.PharmacyInventory", "LinkedAlternative")
                        .WithMany()
