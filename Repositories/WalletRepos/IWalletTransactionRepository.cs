namespace Med_Map.Repositories.WalletRepos
{
    public interface IWalletTransactionRepository
    {
        ...
        Task<List<WalletTransaction>> GetByWalletIdAsync(Guid walletId, int page, int pageSize = 20);
        Task<List<WalletTransaction>> GetPendingWithdrawalsAsync(int page, int pageSize = 20);
